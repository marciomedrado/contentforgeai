...
import {
  ...
  getEmpresas as getStoredEmpresas, // aliased to avoid conflict
  getFuncionariosUnfiltered as getStoredFuncionariosUnfiltered, // aliased
  getEmpresaById as getStoredEmpresaById, // aliased
...
export function ContentListClient() {
  ...
  const refreshData = useCallback(() => {
    ...
    setAllEmpresas(getStoredEmpresas());
    setAllFuncionarios(getStoredFuncionariosUnfiltered());
  }, []);
  ...
  useEffect(() => {
    ...
    if (activeEmpresaIdGlobal && activeEmpresaIdGlobal !== ALL_EMPRESAS_OR_VISAO_GERAL_VALUE) {
      setCurrentActiveEmpresaDetails(getStoredEmpresaById(activeEmpresaIdGlobal));
    } else {
